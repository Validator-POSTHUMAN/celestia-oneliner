...
configure_network() {
    ...
    if [[ "$NETWORK_TYPE" == "mainnet" ]]; then
        ...
        set_network_value "$mode" APP_VERSION "v9.0.4-mocha"
        set_network_value "$mode" DEFAULT_CHAIN_ID "mocha-4"
        set_network_value "$mode" SNAPSHOT_PRUNED "https://snapshots.posthuman.digital/celestia-testnet/snapshot-latest.tar.lz4"
        ...
        set_network_value "$mode" PEERS "52d364fac77753f5ab0df76b6b21ad519e759aa9@135.181.227.236:39656"
